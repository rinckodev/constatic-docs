...
When generating the project using the [CLI](/discord/start), you can select the `discloud project` feature, which will cause the two files needed to upload your application to the hosting to be included in the project.
