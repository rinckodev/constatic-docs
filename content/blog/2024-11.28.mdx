...
- 😫 No portal só é possível fazer o upload de 1 emojis por vez <span className="text-xs text-muted-foreground">(Imagina enviar 2000 emojis um por um)</span>
